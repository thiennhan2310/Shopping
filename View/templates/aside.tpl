...
<div class="product-bottom">
    ...
    <div class="product-go">
        <div class=" fashion-grid">
            <a href="#"><img class="img-responsive " src="{root}/images/p1.jpg" alt=""></a>
    ...
    <div class="product-go">
        <div class=" fashion-grid">
            <a href="#"><img class="img-responsive " src="{root}/images/p2.jpg" alt=""></a>
...
<div class=" per1">
    <a href="#" ><img class="img-responsive" src="{root}/images/pro.jpg" alt="">
        <div class="six1">
            <h4>HÌNH</h4>
            <p>DISCOUNT CÙNG </p>
            <span>HÀNG</span>
